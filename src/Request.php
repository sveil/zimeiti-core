...
class Request
{
    ...
    {
        $request = new static($config->pull());
     ...
     * 设置或者获取当前请求的调度信息
     * @access public
     * @param  \sveil\route\Dispatch  $dispatch 调度信息
     * @return \sveil\route\Dispatch
     */
